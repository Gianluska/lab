...
gltfLoader.load("models/characterFinal.glb", (gltf) => {
  character = gltf.scene;
  scene.add(character);
  character.position.x = 0.3;
  character.position.y = -objectsDistance * 0 - 1.5;
  character.position.z = 4.5;
  sectionMeshes.unshift(character);
});
 ...
 * Post Processing
 */
let screenResolution = new THREE.Vector2(sizes.height, sizes.height);
